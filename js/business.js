window.addEventListener("load", async (e) => {
    ...
    let response = await fetch(`https://gnews.io/api/v3/topics/business?token=cf902523c81401eec78c363210e7755c`);
...
queryBox.addEventListener("keypress", async (e) => {
    if (e.key == "Enter") {
        ...
        let response = await fetch(`https://gnews.io/api/v3/search?q=${e.target.value}&token=cf902523c81401eec78c363210e7755c`);
        console.log(response)
