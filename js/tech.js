window.addEventListener("load", async (e) => {
    ...
    let response = await fetch(`https://gnews.io/api/v3/topics/technology?token=cf902523c81401eec78c363210e7755c&max=100`);
    ...
    <h2 class="text-center">Top 100 Tech News</h2>
</div>`
